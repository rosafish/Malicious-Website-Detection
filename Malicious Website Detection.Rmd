...
influenceIndexPlot(inf.mod.full)
residualPlots(inf.mod.full)
outlier <- website [-c(443,898, 468,897,671,72,558),]
inf.mod.no.outlier <- glm(Type ~ . , data = outlier, family = binomial)
influenceIndexPlot(inf.mod.no.outlier)
